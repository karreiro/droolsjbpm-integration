...
public class KieServerInstanceManagerTest {
    ...
    public void testGetContainersRemoteOperationWhenResponseTypeIsSUCCESS() {
        ...
        doReturn(response).when(client).getContainerInfo(anyString());
    ...
    public void testGetContainersRemoteOperationWhenResponseTypeIsNotSUCCESS() {
        ...
        verify(container,
               never()).setContainerSpecId(anyString());
        verify(container,
               never()).setContainerName(anyString());
        verify(container,
               never()).setResolvedReleasedId(any(ReleaseId.class));
        verify(container,
               never()).setServerTemplateId(anyString());
        verify(container,
               never()).setStatus(any(KieContainerStatus.class));
        verify(container,
               never()).setMessages(anyCollectionOf(Message.class));
    }
}
