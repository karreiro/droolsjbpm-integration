...
public class RuleCapabilitiesServiceImplTest extends AbstractServiceImplTest {
    ...
    public void testUpgradeContainerWhenContainerSpecStatusIsStopped() {
        ...
        doReturn(fakeResult).when(kieServerInstanceManager).upgradeAndStartContainer(any(ServerTemplate.class), any(ContainerSpec.class));
        ...
        verify(kieServerInstanceManager).upgradeAndStartContainer(any(ServerTemplate.class), any(ContainerSpec.class));
